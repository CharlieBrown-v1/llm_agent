...
def lumos_iterative(args):
    ...
    for i in tqdm(range(15)):
        ...
        if args.model_name_or_path:
            ...
            model_name_or_path = os.path.join(args.model_name_or_path, "lumos_web_agent_plan_iterative")
        ...
        if args.model_name_or_path:
            print("Loading model and tokenizer...")
            model_name_or_path = os.path.join(args.model_name_or_path, "lumos_web_agent_ground_iterative")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default=lumos_dir_path.joinpath('data/eval/mind2web'), help="data directory.")
    parser.add_argument("--max_num_examples", type=int, default=10, help="maximum number of examples to evaluate.")
    parser.add_argument("--save_dir", type=str, default=lumos_dir_path.joinpath('results/mind2web'), help="directory to save the results.")
