...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default=lumos_dir_path.joinpath('data/eval/webshop'), help="data directory.")
    parser.add_argument("--max_num_examples", type=int, default=10, help="maximum number of examples to evaluate.")
    parser.add_argument("--save_dir", type=str, default=lumos_dir_path.joinpath('results/webshop'), help="directory to save the results.")
    parser.add_argument("--model_name_or_path", type=str, default='ai2lumos', help="if specified, we will load the model to generate the predictions.")
    ...
    parser.add_argument("--load_in_8bit", action="store_false", default=True, help="load model in 8bit mode, which will reduce memory and speed up inference.")
    
    parser.add_argument("--gptq", action="store_true", help="If given, we're evaluating a 4-bit quantized GPTQ model.")

    parser.add_argument("--debug", action="store_false", default=True, help="Debug flag.")
