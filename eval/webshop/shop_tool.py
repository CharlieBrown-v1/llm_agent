...
model_name_or_path = 'cross-encoder/stsb-roberta-large'
model_name_or_path = hf_cache_dir.joinpath('models--cross-encoder--stsb-roberta-large/snapshots/9e35bf01ec28b309411c8903d0d4165567303eb4')
